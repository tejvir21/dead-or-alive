  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-void-900 px-4">
      ...
      >
        <Link
          to="/"
          className="font-mono text-xs text-green-500/60 hover:text-green-400 mb-6 block"
        >
          ← BACK
        </Link>
        <h1 className="font-display text-4xl tracking-wider neon-text mb-1">
          SIGN IN
        </h1>
        <p className="font-body text-gray-500 text-sm mb-8">
          Enter your credentials to access the escape
        </p>
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="survivor@escape.io"
              required
            />
          </div>
          <div>
